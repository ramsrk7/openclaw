...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  A2aEvent: A2aEventSchema,
  SendParams: SendParamsSchema,
  PollParams: PollParamsSchema,
  AgentParams: AgentParamsSchema,
  A2aSendParams: A2aSendParamsSchema,
  A2aSendResult: A2aSendResultSchema,
  ...
  A2aWaitParams: A2aWaitParamsSchema,
  A2aWaitResult: A2aWaitResultSchema,
  A2aCancelParams: A2aCancelParamsSchema,
  A2aCancelResult: A2aCancelResultSchema,
  A2aPushRegisterParams: A2aPushRegisterParamsSchema,
  A2aPushRegisterResult: A2aPushRegisterResultSchema,
  A2aPushUnregisterParams: A2aPushUnregisterParamsSchema,
  A2aPushUnregisterResult: A2aPushUnregisterResultSchema,
